...
<?php if(auth()->guard()->check()): ?>
    ...
    <div class="container rounded mt-5 mb-5 content-container text-white custom-profile-container shadow-lg" style="background-color: #404A3D; box-shadow: 0px 4px 20px rgba(0, 0, 0, 0.3)">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class="p-1 py-5">                 
                    <h4 class="text-right" style="color:#EDDD5E;margin-bottom: 20px; font-weight:bolder">Your Ecopoints: <?php echo e(Auth::user()->points); ?></h4>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 text-center">
                            <button type="submit" class="btn" style="background-color:#EDDD5E; margin-top: 10px">Save Profile</button>
                        </div>
                    </form>
                    <div class="mt-4 text-center">
...
<?php if(auth()->guard()->guest()): ?>
    <div class="container">
        <div class="text-center mx-auto pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px; margin-bottom: 75px">
            <p class="section-title bg-white text-center px-3" style="color: #404A3D; font-weight: bolder">EcoProfile</p>
            <h1 class="mb-5">Welcome EcoFriend!</h1>
        </div>
    </div>
