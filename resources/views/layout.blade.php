...
<head>
    ...
    <title>EcoHaul | @yield('title')</title>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
          <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="{{ route('newsletter.list') }}" class="nav-item nav-link active">Newsletter</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown">Services</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="{{ route('pickup') }}" class="dropdown-item">Pick Up</a>
                        <a href="{{ route('dropoff') }}" class="dropdown-item">Drop Off</a>
                        <a href="{{ route('rewards') }}" class="dropdown-item">EcoRewards</a>
                    </div>
                </div>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-light m-0">
                        ...
                        <a href="{{ route('transaction.history') }}" class="dropdown-item">Transaction History</a>
                        <a href="{{ route('redeem.history') }}" class="dropdown-item">Redeem History</a>
                    </div>
                </div>
          </div>
      ...
      <div class="container">
          <div class="row">
              <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                  &copy; <a class="fw-semi-bold" href="{{route('home')}}" style="color: #5B8C51">EcoHaul</a>, All Right Reserved.
              </div>
          </div>
      </div>
  </div>
